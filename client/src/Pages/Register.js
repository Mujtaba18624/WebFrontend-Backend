                                ...
                                <div className="card-body py-4">
                                    <form action="#">
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input type="password" className="form-control shadow-none" value={cpassword} onChange={e => setcpass(e.target.value)} 
                                            placeholder="Confirm Password"  /><br />
                                        </div>
                                        <div className="form-group">
                                            <label >Address</label>
                                            <input type="text" className="form-control shadow-none" value={address} onChange={e => setAddress(e.target.value)}
                                            placeholder="Address"  /><br />
                                        </div>
                                        <div className="form-group">
                                            <label >Contact</label>
                                            <input type="number" className="form-control shadow-none" value={contact} onChange={e => setContact(e.target.value)}
                                             placeholder="Contact"  />
                                        </div>
                                        <br /><br />
                                        <div className="form-group">    
